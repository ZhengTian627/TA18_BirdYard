  ...
  <div class="plant-advice-container">
    ...
    <div class="banner">
      ...
      <p class="banner-subtitle">
        INPUT YOUR LOCATION, CLICK 'GO GREEN', UNDERSTAND YOUR PLANT BASED ON YOUR CLIMATE
      </p>
      <p class="banner-subtitle">
        WE ONLY PROVIDE SERVICE FOR VICTORIA, SOUTH AUSTRALIA AND QUEENSLAND
      </p>
    </div>
    ...
    <div class="content-section">
      ...
      <div class="recommendations-section" v-if="selectedSeason && userHasInteracted">
    ...
    <section class="cta-section">
      <router-link to="/bird" class="btn btn-large">To see endangered bird?</router-link>
    </section>
  </div>
</template>
