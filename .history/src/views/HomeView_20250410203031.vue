    ...
    <section class="hero">
      <div class="hero-content">
        ...
        <p class="hero-subtitle">
          As our climate changes, bird habitats shrink. <br />Plant the right flowers in your garden
          to create a haven for local birds:<br />
          together we can restore what's being lost.
        </p>
