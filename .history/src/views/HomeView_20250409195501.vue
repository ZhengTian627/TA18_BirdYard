    ...
    <section class="info-section">
      <div class="container">
        ...
        <div class="info-card-wrapper">
          <div class="info-card">
            <div class="card-image" @click="togglePlantInfo">
              <img src="@/assets/images/plant-importance.jpg" alt="Plant importance" />
              <div class="card-overlay">
                <h3>Plants: The Garden Foundation</h3>
                <span class="learn-more">{{ showPlantInfo ? 'Close' : 'Learn More' }}</span>
              </div>
            </div>

            <transition name="slide">
              <div class="info-panel" v-show="showPlantInfo">
                <div class="info-content">
                  <button class="close-panel" @click="togglePlantInfo">&times;</button>
        ...
        <div class="info-card-wrapper align-right">
          <div class="info-card">
            <div class="card-image" @click="toggleBirdInfo">
              <img src="@/assets/images/attracting-birds.jpg" alt="Attracting birds" />
              <div class="card-overlay">
                <h3>Attracting Birds with Plants</h3>
                <span class="learn-more">{{ showBirdInfo ? 'Close' : 'Learn More' }}</span>
              </div>
            </div>

            <transition name="slide-right">
              <div class="info-panel right-panel" v-show="showBirdInfo">
                <div class="info-content">
                  <button class="close-panel" @click="toggleBirdInfo">&times;</button>
...
export default defineComponent({
  ...
  methods: {
    togglePlantInfo() {
      this.showPlantInfo = !this.showPlantInfo
    },
    toggleBirdInfo() {
      this.showBirdInfo = !this.showBirdInfo
    },
  },
})
</script>
...
.close-panel {
  ...
  width: 30px;
  height: 30px;
  background-color: rgba(194, 229, 156, 0.7);
  border: none;
  border-radius: 50%;
  color: #0a3200;
  font-size: 24px;
...
.close-panel:hover {
  background-color: rgba(194, 229, 156, 1);
}
...
@media (max-width: 992px) {
  ...
  .right-panel {
    ...
    margin-top: -8px; /* Negative margin to connect with card */
  }
